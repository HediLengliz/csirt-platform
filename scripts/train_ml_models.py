...
def train_ml_models():
    ...
    try:
        ...
        if len(events) < 10:
            print(f"⚠️  Only {len(events)} events found. Need at least 10 events for training.")
            ...
            for i in range(15):
                event = Event(
                    ...
                    event_type=EventType.SUSPICIOUS_ACTIVITY if i % 3 == 0 else EventType.LOGIN_FAILURE,
