...
def create_test_events():
    ...
    try:
        ...
        print("Summary:")
        print(
            f"  Critical Alert: ML Score = {alert1.ml_score:.3f} ({alert1.ml_score*100:.1f}%)"
        )
        print(
            f"  High Alert: ML Score = {alert2.ml_score:.3f} ({alert2.ml_score*100:.1f}%)"
        )
        print(
            f"  Medium Alert: ML Score = {alert3.ml_score:.3f} ({alert3.ml_score*100:.1f}%)"
        )
        print(
            f"  Low Alert: ML Score = {alert4.ml_score:.3f} ({alert4.ml_score*100:.1f}%)"
        )
        print("\n✅ Test events created successfully!")
        print(
            "✅ Check the frontend at http://localhost:3000/alerts to see the ML scores!"
        )
        print("=" * 60)
