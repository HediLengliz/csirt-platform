...
try:
    ...
    def test_ml_scoring():
        ...
        print("=" * 60)
        print("Summary:")
        print(f"- Test 1 (Malware): Score = {ml_score:.3f}, Priority = {priority.value}")
        print(f"- Test 2 (Brute Force): Score = {ml_score2:.3f}, Priority = {priority2.value}")
        print(f"- Test 3 (Login Failure): Score = {ml_score3:.3f}, Priority = {priority3.value}")
        print()
